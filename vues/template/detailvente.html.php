  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <label class="card-text"><h5>NUMERO de SERIE</h5></label><span id="ville"> <?= $vente['serie'] ?></span> <br>
...
<div class="card mb-3" style="max-width: 540px;">
  <div class="row no-gutters">
    <div class="col-md-12">
      <div class="card-body">
        <h4 class="card-title">Detail du client</h4>
        <label class="card-text"><h5>NOM du Client</h5></label> <span id="nomtut"><?= $vente['nom_client'] ?></span> <br>
        <label class="card-text"><h5>PRENOM du Client</h5></label><span id="prenomtut"><?= $vente['prenom_client'] ?></span> <br>
        <label class="card-text"><h5>CNIB du client</h5></label><span id="professiontut"> <?= $vente['cnib_client'] ?></span> <br>
        <label class="card-text"><h5>CONTACT du client</h5></label><span id="genretut"> <?= $vente['numero_client'] ?> </span> <br>
        <label class="card-text"><h5>SOMME de la vente</h5></label><span id="contacttut"> <?= $vente['somme'] ?> FCFA</span> <br>
      </div>
    </div>
  </div>
</div>
