...
<img src="../style/img/erreur404.jpg" alt="PHOTO d'erreur404">




<button type="button" class="btn btn-outline-primary sbouton2"onclick="versenregistrement()"><a href="../home/index">Retour a la page d'accueil</a></button>