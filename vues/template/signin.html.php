...
<div class="image">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item ">
        <a class="nav-link navcol" href="../connexion/login">Connexion</a>
      </li>
...
<h1 id="bienvenu"> Nouvel Administrateur</h1>

<form action="../connexion/signin" method="POST">
  <div class="form-group">
    <input type="text" name="nom" required class="form-control" id="exampleFormControlInput1" placeholder="Nom" required>
  </div>
  <div class="form-group">
    <input type="text" name="prenom" required class="form-control" id="exampleFormControlInput1" placeholder="Prenom" required>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <a href="../formulaire/login">CONNEXION</a>
